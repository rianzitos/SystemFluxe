...
<head>
    ...
    <link rel="shortcut icon" href="/logo_fluxe.png" type="image/png">
...
<body class="fundoAdm">
    ...
    <header class="headerLogin">
        <img id="logotipo" src="/logotipo.svg" alt="Logotipo da empresa">
    ...
    <div class="circuit-line">
        <img src="/linhaCircuito.png" alt="Linha de circuito amarelo">
    </div>

    <!-- IMAGEM DO CIRCUITO -->
    <div class="circuit-decoration">
        <img src="/circuito.png" alt="">
    </div>
